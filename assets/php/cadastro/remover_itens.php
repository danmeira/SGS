...
$query = "SELECT * FROM c_fornecedores WHERE cnpj = '$cnpj'";
$query = mysqli_query($connection, $query) or die($connection);
$query = mysqli_fetch_row($query);

$delete = "DELETE FROM c_fornecedores WHERE id = '$query[0]'";
$delete = mysqli_query($connection, $delete) or die($connection);

$atividade = "O fornecedor " . $query[1] . " de ID " . $query[0] . "foi removido.";
