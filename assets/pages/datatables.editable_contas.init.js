			...
			$row.children( 'td' ).each(function( i ) {
				...
				if ( $this.hasClass('actions') ) {
					...
					if (i == 0) {
			            ...
			            xmlhttp.onreadystatechange = function(){
		                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
		                        ...
		                        for (var x = 0; x < returnval.length; x++) {
		                        	returnval[x] = returnval[x].replace("Sa\uFFFDde", "Sa\u00FAde");
		                        	returnval[x] = returnval[x].replace("\uFFFD", "\u00ED");
		                        }
		                        ...
		                        for (var x = 0; x < returnval.length; x++) {
		                        	if (x != returnval.length) {
		                        		temp = "<option>" + returnval[x] + "</option>";
			            ...
			            xmlhttp.open("POST", "../../assets/php/cadastro/consultar_fontes.php", true);
